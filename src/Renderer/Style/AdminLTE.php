...
class AdminLTE
{
    ...
    const PANEL_HEAD_CLASS = 'box-header with-border';
    const PANEL_HEAD_CLASS_TITLE = 'box-title';
    const PANEL_HEAD_CLASS_ACTIONS = 'box-tools';
    const PANEL_BODY_CLASS = 'box-body';
